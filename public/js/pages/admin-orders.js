...
createApp({
  setup() {
    ...
    const statusMap = {
      pending: { label: '待付款', cls: 'text-apricot border-apricot/40' },
      paid: { label: '已付款', cls: 'text-sage border-sage/40' },
      failed: { label: '付款失敗', cls: 'text-rose-primary border-rose-primary/40' },
    };
